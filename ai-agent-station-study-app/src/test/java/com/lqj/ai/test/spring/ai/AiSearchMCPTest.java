package com.lqj.ai.test.spring.ai;
...
public class AiSearchMCPTest {
    ...
    public void test() {
        OpenAiChatModel chatModel = OpenAiChatModel.builder()
                .openAiApi(OpenAiApi.builder()
                        ...
                        .apiKey("sk-eVe68aG0y8ZLaWXrFbDbC0FcC13e4654Aa19644474F33d58")
    ...
    public McpSyncClient sseMcpClient() {
        HttpClientSseClientTransport sseClientTransport = HttpClientSseClientTransport.builder("http://appbuilder.baidu.com/v2/ai_search/mcp/")
                .sseEndpoint("sse?api_key=bce-v3/ALTAK-KgzEw6Yhy2B2gzfmpy8Mr/1a6d8893b3dc317727f13d84ce24a53135d7a022")
                .build();
